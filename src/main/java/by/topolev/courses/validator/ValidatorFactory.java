...
public class ValidatorFactory {
	...
	static {
		accessValidators.put(ENTERED_FILENAME_VALIDATOR, new AvailableImageExtansionValidator(ERR_MSG_ENTERED_FILENAME));
		accessValidators.put(UPLOAD_FILENAME_VALIDATOR, new AvailableImageExtansionValidator(ERR_MSG_UPLOAD_FILENAME));
